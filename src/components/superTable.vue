    ...
    <div>
        ...
        <table class="table table-bordered table-hover">
            ...
            <tbody>
                ...
                -->
                <tr v-for="(tr, trIndex) in config.data"
                    :key="trIndex"
                    :data-index="trIndex"
                        ...
                        <template v-for="(td ,tdIndex) in config.colOption">
                            <td :key="tdIndex">
                                ...
                                <template v-if="config.colOption[tdIndex]['jsxRender']">
                                    <jsxDom :row="tr" :jsxRender="config.colOption[tdIndex]['jsxRender']" :index="tdIndex"></jsxDom>
                                </template>
                                ...
                                <template v-else>
                                    {{ tr[config.colOption[tdIndex]['field']] }}
                                </template>
                            </td>
                        </template>
                ...
                <tr v-if="!config.data || config.data.length == 0">
                    <td class="text-center" :colspan="countAllCol">
                        暂无数据
                    </td>
                </tr>
...
export default {
    ...
    methods : {
        ...
        singleSelect(e, tr){
            ...
            //  单选按钮点击
            if(targetName == "INPUT" && target.type == "checkbox" && target.dataset["checkbox"]){
